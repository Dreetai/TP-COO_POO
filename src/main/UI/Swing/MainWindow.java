...
import main.structure.Conversation;
import main.structure.Quadruplet;
...
public class MainWindow extends JFrame {
    ...
    public MainWindow(Utilisateur mainUtilisateur) {
        ...
        System.out.println("Mon port est "+mainUtilisateur.getPort()+" je suis dans mainWindow");
    ...
    public void initialiserJFrame() {
        ...
        this.addWindowListener(new WindowAdapter()
        {
            ...
            {
                BaseDeDonnees.deleteUtilisateur(mainUtilisateur);
                UDPMessageSenderService udpMessageSenderService = new UDPMessageSenderService();
                try {
                    for(Utilisateur u :listeConnecte){
